/*
  # Fix face data synchronization
  
  1. Changes
    - Drop and recreate face_data table with proper constraints
    - Add trigger to sync with face_index
    - Update RLS policies
*/
...
-- Create policies for face_index
...
-- Create trigger function for face data sync
