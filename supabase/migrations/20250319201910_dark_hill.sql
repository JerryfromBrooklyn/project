/*
  # Fix photos table schema and column names

  1. Changes
    - Ensure all column names match TypeScript interfaces
    - Add proper constraints and defaults
    - Fix column types and references
...
CREATE TABLE public.photos (
  ...
  event_details jsonb DEFAULT '{"date": null, "name": null, "type": null}',
...
-- Create storage trigger function if it doesn't exist
