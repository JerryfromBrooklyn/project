        ...
        try {
            ...
            try {
                ...
                if (insertError) {
                    ...
                    try {
                        const { data: rpcData, error: rpcError } = await supabase.rpc('add_simple_photo', photoMetadata);
                        if (rpcError) {
