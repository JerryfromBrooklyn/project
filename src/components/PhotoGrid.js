...
export const PhotoGrid = memo(({ photos, onDelete, onShare, onTrash }) => {
    ...
    const columnCount = windowSize.width < 768 ? 2 : windowSize.width < 1024 ? 2 : 4;
    const gridWidth = gridContainerRef.current ? gridContainerRef.current.offsetWidth : windowSize.width;
    ...
    return _jsxs(_Fragment, { children: [
        _jsx("div", {
            ...
            className: "w-full",
            children: gridContainerRef.current && _jsx(FixedSizeGrid, {
                className: "virtualized-photo-grid",
                columnCount: columnCount,
                columnWidth: cellWidth,
                height: Math.min(rowCount * cellHeight, windowSize.height * 0.8),
                rowCount: rowCount,
