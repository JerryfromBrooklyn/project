                ...
                _jsxs(motion.div, { 
                    ...
                    children: [
                        ...
                        photo.faces && (_jsxs("div", { 
                            className: cn("absolute top-2 right-2 px-2 py-1 rounded-full text-sm flex items-center gap-1", "bg-apple-blue-500/80 text-white backdrop-blur-sm"), 
                            children: [
                        ...
                        _jsx("div", { 
                            className: "absolute inset-0 bg-black/50 rounded-apple-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300", 
                            children: _jsxs("div", { 
                                ...
                                children: [
                                    _jsxs("div", { 
                                        ...
                                        children: [
                                            ...
                                            onShare && (_jsx("button", { 
                                                onClick: (e) => { e.stopPropagation(); onShare(photo.id); }, 
                                                className: "p-2 rounded-full bg-white/10 hover:bg-white/20 text-white transition-colors duration-300", 
                                        ...
                                        children: [
                                            ...
                                            onTrash && (
                                                _jsx("button", { 
                                                    ...
                                                    className: "p-2 rounded-full bg-red-500/20 hover:bg-red-500/40 text-red-100 transition-colors duration-300", 
