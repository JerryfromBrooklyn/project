...
const Login = () => {
    ...
    return (_jsxs("div", { className: "max-w-md mx-auto mt-8 p-6 bg-white rounded-lg shadow-md", children: [_jsx("h2", { className: "text-2xl font-semibold text-center mb-6", children: "Sign In" }), message && (_jsx("div", { className: "mb-4 p-3 bg-green-100 border border-green-400 text-green-700 rounded", children: message })), error && (_jsx("div", { className: "mb-4 p-3 bg-red-100 border border-red-400 text-red-700 rounded", children: error })), _jsxs("form", { onSubmit: handleSubmit, children: [_jsxs("div", { className: "mb-4", children: [_jsx("label", { htmlFor: "email", className: "block text-gray-700 mb-2", children: "Email Address" }), _jsx("input", { id: "email", type: "email", className: "w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500", value: email, onChange: (e) => {
                                    console.log('[LOGIN] Email changed:', e.target.value);
                                    setEmail(e.target.value);
                                }, required: true })] }), _jsxs("div", { className: "mb-6", children: [_jsxs("div", { className: "flex justify-between items-center mb-2", children: [_jsx("label", { htmlFor: "password", className: "block text-gray-700", children: "Password" }), _jsx(Link, { to: "/forgot-password", className: "text-sm text-blue-500 hover:text-blue-700", children: "Forgot Password?" })] }), _jsx("input", { id: "password", type: "password", className: "w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500", value: password, onChange: (e) => {
                                    console.log('[LOGIN] Password changed (length):', e.target.value.length);
                                    setPassword(e.target.value);
                                }, required: true })] }), _jsx("button", { type: "submit", className: "w-full bg-blue-500 text-white py-2 px-4 rounded-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 transition-colors", disabled: loading, onClick: () => console.log('[LOGIN] Submit button clicked'), children: loading ? 'Signing In...' : 'Sign In' })] }), _jsxs("p", { className: "mt-4 text-center text-gray-600", children: ["Don't have an account? ", _jsx(Link, { to: "/signup", className: "text-blue-500 hover:text-blue-700", children: "Sign Up" })] })] }));
};
