                ...
                _jsx("div", { 
                    ...
                    children: attributes.map((attr, index) => (
                        _jsxs("div", { 
                            ...
                            children: [
                                _jsx("div", { 
                                    className: "mr-2 text-apple-gray-500", 
                                    children: attr.icon 
                                }), 
                                _jsxs("div", { 
                                    children: [
                                        ...
                                        _jsxs("div", { 
                                            className: "text-xs text-apple-gray-500", 
                                            children: [
                ...
                return _jsxs("div", { 
                    ...
                    children: [
                        _jsx("div", { 
                            ...
                            children: _jsxs("h2", { 
                                className: "text-xl font-semibold text-apple-gray-900 flex items-center", 
                                children: [
                                    _jsx(Upload, { className: "w-5 h-5 mr-2 text-apple-blue-500" }), 
                                    "Upload Photos"
                                ] 
                            }) 
                        }), 
                        _jsx("p", { 
                            className: "text-apple-gray-600 mb-6 border-l-4 border-apple-blue-500 pl-4 py-2 bg-apple-blue-50 rounded-r-apple", 
                            children: "Upload photos to be indexed for facial recognition. Other users will be able to find photos they appear in." 
                        }), 
                    ...
                    children: [
                        _jsx("div", { 
                            ...
                            children: _jsxs("h2", { 
                                className: "text-xl font-semibold text-apple-gray-900 flex items-center", 
                                children: [
                                    _jsx(Photos, { className: "w-5 h-5 mr-2 text-apple-blue-500" }), 
                                    "My Photos"
                                ] 
                            }) 
                        }), 
                        _jsx("p", { 
                            className: "text-apple-gray-600 mb-6 border-l-4 border-apple-blue-500 pl-4 py-2 bg-apple-blue-50 rounded-r-apple", 
                            children: "Photos where you have been identified through facial recognition." 
                        }), 
                    ...
                    children: [
                        _jsx("div", { 
                            ...
                            children: _jsxs("h2", { 
                                className: "text-xl font-semibold text-apple-gray-900 flex items-center", 
                                children: [
                                    _jsx(Calendar, { className: "w-5 h-5 mr-2 text-apple-blue-500" }), 
                                    "Events"
                                ] 
                            }) 
                        }), 
                    ...
                    children: [
                        _jsx("div", { 
                            ...
                            children: _jsxs("h2", { 
                                className: "text-xl font-semibold text-apple-gray-900 flex items-center", 
                                children: [
                                    _jsx(Settings, { className: "w-5 h-5 mr-2 text-apple-blue-500" }), 
                                    "Admin Tools"
                                ] 
                            }) 
                        }),
                        _jsx("p", { 
                            className: "text-apple-gray-600 mb-6 border-l-4 border-apple-blue-500 pl-4 py-2 bg-apple-blue-50 rounded-r-apple", 
                            children: "Advanced tools for administrators to manage system settings and repair functionality."
                        }),
                        _jsx(AdminTools, {})
                    ] 
                });
                    ...
                    children: [
                        _jsxs(motion.div, { 
                            ...
                            children: [
                                    ...
                                    children: [
                                        ...
                                        _jsxs("div", { 
                                            children: [
                                                ...
                                                _jsx("p", { 
                                                    className: "text-apple-gray-500", 
                                                    children: faceRegistered ? 'Your face is registered' : 'Complete your profile by registering your face' 
                                                })
                                            ] 
                                        })
                                    ] 
                                ...
                                faceImageUrl && _jsxs("div", { 
                                    className: "mb-6", 
                                    children: [
                                        _jsx("h3", { 
                                            className: "text-sm font-medium text-apple-gray-700 mb-2", 
                                        ...
                                        _jsxs("div", { 
                                            ...
                                            children: [
                                                _jsx("div", { 
                                                    className: "relative w-full max-w-xs aspect-square rounded-apple-xl overflow-hidden border border-apple-gray-200", 
                                                    children: _jsx("img", { 
                                                        src: faceImageUrl, 
                                                        alt: "Registered face", 
                        ...
                        _jsxs(motion.div, { 
                            ...
                            children: [
                                _jsxs("h2", { 
                                    className: "text-lg font-medium text-apple-gray-900 mb-6 flex items-center", 
                                    children: [
                                        _jsx(Shield, { className: "w-5 h-5 mr-2 text-apple-blue-500" }), 
                                        "Face Recognition Status"
                                    ] 
                                }), 
                                _jsxs("div", { 
                                    className: "flex items-center p-4 bg-apple-gray-50 rounded-apple mb-4 border border-apple-gray-200", 
                                    children: [
                                        _jsx("div", { 
                                        ...
                                        _jsxs("div", { 
                                            children: [
                                                _jsx("span", { 
                                                    className: "text-sm font-medium text-apple-gray-900", 
                                                    children: faceRegistered ? 'Registered' : 'Not Registered' 
                                                }), 
                                                _jsx("p", { 
                                ...
                                _jsxs("div", { 
                                    ...
                                    children: [
                                        ...
                                        _jsxs("div", { 
                                            ...
                                            children: [
                                                _jsx(AlertCircle, { className: "w-4 h-4 mr-2 text-apple-gray-400 flex-shrink-0 mt-0.5" }), 
                                                _jsx("p", { 
                                                    children: "Your face data is encrypted and stored securely. We never share your biometric data with third parties." 
                                                })
                                            ] 
                                        })
                                    ] 
                            ...
                            _jsxs("div", { 
                                ...
                                children: [
                                    _jsxs("button", { 
                                        ...
                                        children: [
                                            _jsx("div", { 
                                                className: "w-8 h-8 rounded-full bg-apple-blue-100 text-apple-blue-700 flex items-center justify-center", 
                                            ...
                                            _jsx(ChevronDown, { className: "h-4 w-4 text-apple-gray-500" })
                                        ] 
                                    }), 
                                    isMenuOpen && _jsxs(motion.div, { 
            ...
            _jsxs("main", { 
                ...
                children: [
                    _jsx("div", { 
                        ...
                        children: _jsx("nav", { 
                            className: "flex space-x-2 mx-auto bg-apple-gray-200 p-1 rounded-full", 
                            children: renderNavigationButtons()
                        }) 
                    }), 
                    _jsx("div", { 
                        className: cn("grid gap-8", activeTab === 'home' ? "grid-cols-1 lg:grid-cols-3" : "grid-cols-1"), 
                        children: renderContent() 
                    })
                ] 
            }), 
            _jsx(AnimatePresence, { 
                children: showRegistrationModal && _jsx(FaceRegistration, { 
