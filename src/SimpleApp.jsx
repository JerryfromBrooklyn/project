    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-screen p-4">
        <div className="w-full max-w-md bg-white shadow-lg rounded-lg p-8">
          <h1 className="text-2xl font-bold mb-6 text-center">Welcome to the Photo App</h1>
          ...
          <div className="space-y-4">
            ...
            <button
              ...
              className="w-full bg-white text-blue-600 border border-blue-600 py-2 px-4 rounded hover:bg-blue-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
            >
              Create Account
            </button>
          </div>
    ...
    <div className="container mx-auto p-4">
      <div className="flex justify-between items-center mb-8">
        ...
        <div className="flex items-center">
          <p className="mr-4">{user?.email || user?.id}</p>
          <button
            onClick={signOut}
            className="bg-red-600 text-white py-1 px-3 rounded hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2"
          >
            Sign Out
          </button>
        </div>
      ...
      <div>
        ...
        {loadingPhotos ? (
                  ...
                  {photo.matched_users && photo.matched_users.length > 0 && (
                    <div className="mt-2 flex items-center">
                      <span className="text-xs bg-green-100 text-green-800 px-2 py-1 rounded-full">
                        {photo.matched_users.length} matches
                      </span>
                    </div>
                  )}
                </div>
          ...
          <div className="text-center py-8 bg-gray-50 rounded-lg">
            <p className="text-gray-600">No photos found. Upload your first photo above!</p>
          </div>
        )}
      </div>
